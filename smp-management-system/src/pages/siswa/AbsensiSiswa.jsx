...
import { Calendar, Clock, CheckCircle, XCircle, MinusCircle, Heart, TrendingUp } from 'lucide-react'
...
const AbsensiSiswa = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Absensi Pribadi</h1>
          <p className="text-gray-600 mt-2">Riwayat kehadiran dan statistik</p>
        </div>
