    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-2">Jadwal mengajar Anda</p>
        </div>
        
        <div className="flex items-center space-x-2 text-gray-600">
          <Calendar size={24} />
          <span className="text-sm">
            {schedules.length} Kelas • {getTotalTeachingHours().toFixed(1)} Jam
          </span>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">Jam Mengajar</p>
              <p className="text-2xl font-bold text-gray-900">
                {getTotalTeachingHours().toFixed(1)}h
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">Kelas Berbeda</p>
              <p className="text-2xl font-bold text-gray-900">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <span className="font-medium ml-1">Kelas {schedule.classes.level}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            <p className="text-gray-600">
              {selectedDay === getTodaySchedule() 
                ...
                : `Anda tidak memiliki jadwal mengajar pada ${daysOfWeek.find(d => d.value === selectedDay)?.label}`
              }
            </p>
          </motion.div>
        )}
