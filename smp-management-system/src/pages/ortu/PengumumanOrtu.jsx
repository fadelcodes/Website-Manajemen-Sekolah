...
const PengumumanOrtu = () => {
  ...
  const shouldShowAnnouncement = (announcement) => {
    return announcement.is_published && (
      ...
      announcement.target_roles.includes('ortu')
    )
  }
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      const { data, error } = await supabase
        ...
        .or('target_roles.cs.{ortu},target_roles.is.null')
    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-2">Informasi terbaru dari sekolah untuk orang tua</p>
        </div>
