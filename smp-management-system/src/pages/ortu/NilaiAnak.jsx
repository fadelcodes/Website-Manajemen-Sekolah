...
import { TrendingUp, BookOpen, Calendar, Download, User } from 'lucide-react'
...
const NilaiAnak = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Nilai Anak</h1>
          <p className="text-gray-600 mt-2">
            Memantau perkembangan nilai {anak ? `${anak.first_name} ${anak.last_name}` : 'anak'}
          </p>
        </div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                  <div 
                    className={`h-2 rounded-full ${
                      average >= 85 ? 'bg-green-600' :
                      average >= 75 ? 'bg-blue-600' :
                      average >= 65 ? 'bg-yellow-600' :
                      'bg-red-600'
                    }`}
                    style={{ width: `${average}%` }}
                  ></div>
